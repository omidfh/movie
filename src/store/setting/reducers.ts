...
// Remove the WritableDraft import and use SettingState directly
...
export const settingSlice = createSlice({
  ...
  reducers: {
    ...
    saveLocal: (state, action: PayloadAction<string>) => {
    ...
    app_name: (state, action: PayloadAction<string>) => {
      if (typeof action.payload !== typeof undefined) {
    ...
    theme_scheme_direction: (state, action: PayloadAction<string>) => {
      if (typeof action.payload !== typeof undefined) {
    ...
    theme_color: (state, action: PayloadAction<string>) => {
      if (typeof action.payload !== typeof undefined) {
